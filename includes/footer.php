    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-2 col-6 footer-links">
        ...
        <ul>
          ...
          <li><a href="cargo.php">Cargo Consolidation</a></li>
          <li><a href="Freight &Transport.php">Cross-Border Transport</a></li>
          <li><a href="Import&Export.php">Import & Export</a></li>
          <li><a href="door-to-door.php">Last-Mile Delivery</a></li>
          <li><a href="pharmaceuticalShipments.php">Cold Chain Logistics</a></li>
        </ul>
      </div>
      ...
      <div class="certifications mt-4 ">
        ...
        <div class="certification-badges">
          ...
          <span class="badge text-light">TASAC</span>
