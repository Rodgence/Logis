            ...
            <div class="row g-4">
                    ...
                    <div class="card border-0 bg-white rounded-4 overflow-hidden h-100">
                        <div class="row g-0">
                            <div class="col-md-6 order-md-2">
                                <img src="ph.jpg" class="img-fluid h-100 w-100" alt="Air Freight Services"
                ...
                <div class="col-12 mb-5">
                    <div class="card border-0 bg-white rounded-4 overflow-hidden h-100">
                        <div class="row g-0">
                            <div class="col-md-6 order-md-2">
                                <img src="shipment1.jpg" class="img-fluid h-100 w-100" alt="Sea Freight Services"
                                    style="object-fit: cover;">
                            </div>
                            <div class="col-md-6 order-md-1 d-flex align-items-center">
                                <div class="card-body p-4 p-md-5">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <span class="badge bg-light text-dark mb-2 px-3 py-2">Cost-Effective</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 mb-5">
                    <div class="card border-0 bg-white rounded-4 overflow-hidden h-100">
                        <div class="row g-0">
                            <div class="col-md-6">
                                <img src="road.jpg" class="img-fluid h-100 w-100" alt="Road Freight Services"
                                    style="object-fit: cover;">
                            </div>
                            <div class="col-md-6 d-flex align-items-center">
                                <div class="card-body p-4 p-md-5">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <span class="badge bg-light text-dark mb-2 px-3 py-2">Last Mile</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 mb-5">
                    <div class="card border-0 bg-white rounded-4 overflow-hidden h-100">
                        <div class="row g-0">
                            <div class="col-md-6 order-md-2">
                                <img src="RAIL TRANSPORT.jpg" class="img-fluid h-100 w-100" alt="Rail Freight Services"
                                    style="object-fit: cover;">
                            </div>
                            <div class="col-md-6 order-md-1 d-flex align-items-center">
                                <div class="card-body p-4 p-md-5">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <span class="badge bg-light text-dark mb-2 px-3 py-2">Cost Efficient</span>
                                    </div>
                                </div>
                            </div>
                        </div>
